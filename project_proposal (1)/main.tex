...
% Tighter spacing between floats and surrounding text
...
shows the headline savings stay or grow as the input length $M$
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.92\columnwidth]{figures/m_scaling.pdf}
\caption{Per-output energy of FP16 / C7 / C1 on LLM prefill
across $M\!\in\!\{128,\dots,2048\}$.  All three configurations
are nearly $M$-invariant, consistent with the cost decomposition
of Sec.~\ref{sec:mscaling}; the C1-vs-C7 gap stays at
$58$--$59\%$ over the entire range.  VLM and VLA prefill scans
are future work.}
\label{fig:mscan}
\end{figure}
